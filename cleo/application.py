...
from .events.console_events import ConsoleEvents
from .events.console_signal_event import ConsoleSignalEvent
...
class Application:
    ...
    def _run_command(self, command: Command, io: IO) -> int:
        ...
        try:
            self._dispatcher.dispatch(event, ConsoleEvents.COMMAND)
            ...
            self._dispatcher.dispatch(event, ConsoleEvents.ERROR)
            error = event.error
        ...
        self._dispatcher.dispatch(event, ConsoleEvents.TERMINATE)
